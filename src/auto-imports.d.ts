...
export {}
declare global {
  const CompleteExperience: typeof import('./components/experiences/CompleteExperience.jsx')['default']
  const ExperienceList: typeof import('./components/experiences/ExperienceList.jsx')['default']
  const Experiences: typeof import('./components/experiences/Experiences.jsx')['default']
  const Footer: typeof import('./components/common/Footer.jsx')['default']
  const Link: typeof import('react-router-dom')['Link']
  const Map: typeof import('./components/experiences/Map.jsx')['default']
  ...
  const VideoCarousel: typeof import('./components/VideoCarousel.jsx')['default']
