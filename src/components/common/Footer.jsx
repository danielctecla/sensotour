const navigation = {
  Equipo: [
    { name: 'Daniel Catonga', href: 'https://github.com/danielctecla' },
    { name: 'Manuel Olguin', href: 'https://github.com/mvnueloc' },
    { name: 'Artemisa Navarro', href: 'https://www.instagram.com/ati_cobain' },
    { name: 'Emilio Martinez', href: 'https://www.linkedin.com/in/e-mtz/' },
  ],
  social: [
    {
      name: 'GitHub',
...
export default function Footer() {
  return (
    <footer
      className="bg-[#ea3060] block md:pl-30"
